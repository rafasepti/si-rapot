...
Route::middleware(['checkRole:Guru'])->group(function () {
    ...
    Route::get('/filter_sw', [NilaiController::class, 'filter_sw']);
    Route::get('/filter_n', [NilaiController::class, 'filter_n']);
    ...
    Route::get('/nilai/detail_sw/{id}',[NilaiController::class, 'show_sw']);
