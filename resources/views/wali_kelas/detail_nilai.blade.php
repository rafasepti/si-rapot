                      ...
                      <div class="row">
                            ...
                            @foreach ($mapel as $index => $m)
                              <tr>
                                ...
                                <td>
                                  ...
                                  <input type="number" class="form-control nilai_rl" name="nilai_rl[]" value="" required>
                                </td>
                                ...
                                <td>
                                  <textarea name="ket[]" class="form-control ket" required></textarea>
                                </td>
                              </tr>
                            @endforeach
                          </tbody>
                        ...
                        <table class="table table-striped table-bordered">
                          ...
                          <tbody>
                            <tr>
                              <td>
                                <textarea class="form-control" style="height: 100px" name="catatan" required>{{ $nilai1->catatan }}</textarea>
                              </td>
                            </tr>
                          </tbody>
                        </table>
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td class="text-center">
                                <div class="row">
                                  <div class="col-md-4">
                                    <input type="number" class="form-control" name="kehadiran_sakit" required value="{{ $nilai1->kehadiran_sakit }}">
                                  </div>
                                  <div class="col-md-2">
                                    Hari
                                  </div>
                            ...
                            <tr>
                              ...
                              <td class="text-center">
                                  <div class="row">
                                    <div class="col-md-4">
                                      <input type="number" class="form-control" name="kehadiran_izin" required value="{{ $nilai1->kehadiran_izin }}">
                                    </div>
                                    <div class="col-md-2">
                                      Hari
                                    </div>
                            ...
                            <tr>
                              ...
                              <td class="text-center">
                                <div class="row">
                                  <div class="col-md-4">
                                    <input type="number" class="form-control" name="kehadiran_tanpa_ket" required value="{{ $nilai1->kehadiran_tanpa_ket }}">
                                  </div>
                                  <div class="col-md-2">
                                    Hari
                                  </div>
