                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                      ...
                                      <td>
                                        ...
                                        <input type="number" class="form-control nilai_rl" name="nilai_rl[]" value="{{ $nilai1[$index]->nilai_rl ?? '' }}" required>
                                      </td>
                                      <td><input type="number" class="form-control nilai_tp" name="nilai_tp[]" value="{{ $nilai1[$index]->nilai_tp ?? '' }}"  required></td>
                                      <td>
                                        <input type="number" class="form-control nilai_as" name="nilai_as[]" value="{{ $nilai1[$index]->nilai_as ?? '' }}" required>
                                      </td>
                                      <td>
                                        <textarea name="ket[]" class="form-control" required>{{ $nilai1[$index]->ket ?? '' }}</textarea>
                                      </td>
                                    </tr>
                                    @endforeach
                                  </tbody>
                                  ...
                                  <div class="col-md-6">
                                    <div class="row mb-3">
                                      ...
                                      <div class="row mb-3">
                                        <label for="inputText" class="col-sm-3 col-form-label col-form-label-sm">Mata Pelajaran</label>
                                        <div class="col-sm-9">
                                          <select class="form-select" aria-label="Default select example" required name="id_mapel2">
                                            @foreach ($mapel2 as $m)
                                              <option value="{{ $m->id_mp }}">{{ $m->nama_mapel }}</option>
                                            @endforeach
                                          </select>
                                ...
                                <table class="table table-striped table-bordered">
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                      ...
                                      <td>{{ $s->nama_siswa }}</td>
                                      <td>
                                        <input type="hidden" class="form-control" name="id_siswa2[]" value="{{ $s->id }}" required>
                                        <input type="number" class="form-control nilai_rl2" name="nilai_rl2[]" required>
                                      </td>
                                      <td><input type="number" class="form-control nilai_tp2" name="nilai_tp2[]" required></td>
                                      <td>
                                        <input type="number" class="form-control nilai_as2" name="nilai_as2[]" required>
                                      </td>
                                      <td>
                                        <textarea name="ket2[]" class="form-control" required></textarea>
                                      </td>
                                    </tr>
                                    @endforeach
                                  </tbody>
